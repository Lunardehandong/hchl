		...
		<div id="fh5co-blog">
			<div class="row">
				...
				<div class="col-md-4">
					...
					<img src="images/productos/Rayador.jpg"  class="img-responsive">
						<div class="blog-text">
							<h3><a href="images/productos/Rayador.jpg">Supreme Food Cutter</a></h3>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<img src="images/productos/pans.jpg"  class="img-responsive">
						<div class="blog-text">
							
							<h3><a href="images/productos/pans.jpg">1 QT. ALL PURPOSE PAN</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.</p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<img src="images/productos/milks.jpg"  class="img-responsive">
						<div class="blog-text">
							
							<h3><a href="images/productos/milks.jpg">Milk pan 1/2 qt</a></h3>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
						</div> 
