		...
		<div id="fh5co-blog">
			<div class="row">
				...
				<div class="col-md-4">
					...
					<img src="images/productos/8s.jpg"  class="img-responsive">
						<div class="blog-text">
							<h3><a href="images/productos/8s.jpg">8 Gourmet Skillet W/Lid</a></h3>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<img src="images/productos/10s.jpg"  class="img-responsive">
						<div class="blog-text">
							
							<h3><a href="images/productos/10s.jpg">10 Gourmet Skillet W/Lid</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.</p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<img src="images/productos/12s.jpg"  class="img-responsive">
						<div class="blog-text">
							
							<h3><a href="images/productos/12s.jpg">12 Gourmet Skillet W/Lid</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.</p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
