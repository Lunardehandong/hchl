	...
	<div class="container-wrap">
		...
		<div id="fh5co-blog">
			...
			<div class="col-md-4">
					...
					<img src="images/productos/teteras.jpg"  class="img-responsive"> 
						<div class="blog-text">
							<h3><a href="images/productos/teteras.jpg">3 Qt Whistling Tea Kettle</a></h3>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<img src="images/productos/MultiPurPoseJumboGrinddle13x19.jpg"  class="img-responsive">
						<div class="blog-text">
							<h3><a href="images/productos/MultiPurPoseJumboGrinddle13x19.jpg">MULTI PURPOSE JUMBO GRIDDLE 13"X19"</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.</p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
					<img src="images/productos/grills.jpg"  class="img-responsive"> 
						<div class="blog-text">
							<h3><a href="images/productos/grills.jpg">12" GRILL PAN</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.<p>
							<ul class="stuff">
								<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
