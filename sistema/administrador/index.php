...
session_start();
if($_POST){
if(($_POST['usuario']=="Raul mora")&&($_POST['contraseña']=="HChl109")){
  

 
  $_SESSION['usuario']="ok";
  $_SESSION['nombreUsuario']="Raul Mora";
   ...
   <div class="container">
       ...
       <div class="col-md-4">
           ...
           <div class="card">
              ...
              <a type="button" class="btn btn-primary" href="../index.php">Empleados</a>
