		...
		<div id="fh5co-blog">
			<div class="row">
				<div class="col-md-4">
                    ...
                    <img src="images/productos/Purifi.jpg"  class="img-responsive">
						<div class="blog-text">
							
							<h3><a href="images/productos/Purifi.jpg">FILTRO DE AIRE</a></h3>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
                    <img src="images/productos/purihc.jpg"  class="img-responsive">
						<div class="blog-text">
							
							<h3><a href="images/productos/purihc.jpg">Purificador de aire</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.</p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
                    <img src="images/productos/ozonificadores.jpg"  class="img-responsive">>
						<div class="blog-text">
							
							<h3><a href="images/productos/ozonificadores.jpg">Ozonificador</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.</p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
                    <img src="images/productos/induccion.jpg"  class="img-responsive">
						<div class="blog-text">
							<h3><a href="images/productos/induccion.jpg">ESTUFA DE INDUCCIÓN</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto. </p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
