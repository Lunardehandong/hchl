		...
		<div id="fh5co-blog">
			<div class="row">
				<div class="col-md-4">
					...
					<img src="images/productos/PrincesaA.jpg"  class="img-responsive">
						<div class="blog-text">
							
							<h3><a href="images/productos/princesaA.jpg">Princesa A</a></h3>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
					<img src="images/productos/PrincesaB.jpg"  class="img-responsive">
						<div class="blog-text">
							<h3><a href="images/productos/princesaB.jpg">Princesa B</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.</p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
					<img src="images/productos/Descarga.jpg"  class="img-responsive">
						<div class="blog-text">
							
							<h3><a href="images/productos/Descarga.jpg">FILTRO DE AGUA</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.</p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
