			...
			<div class="row">
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<a class="blog-bg" style="background-image: url(images/productos/superJumboSkillet12.jpg);"></a>
						<div class="blog-text">
							
							<h3><a href="images/productos/superJumboSkillet12.jpg">12" SUPER JUMBO SKILLET</a></h3>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<a  class="blog-bg" style="background-image: url(images/productos/superJumboSkillet14.jpg);"></a>
						<div class="blog-text">
							
							<h3><a href="images/productos/superJumboSkillet14.jpg">14" SUPER JUMBO SKILLET</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.</p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<a  class="blog-bg" style="background-image: url(images/productos/superJumboSkillet16.jpg);"></a>
						<div class="blog-text">
							
							<h3><a href="images/productos/superJumboSkillet16.jpg">16" SUPER JUMBO SKILLET</a></h3>
							<p>Pongase en contacto con familia HC para una descripción del producto.</p>
							<ul class="stuff">
							<h3><a href="serviciocliente.php">Contactenos para una mayor descripcion y ofertas</a></h3>
							</ul>
